CASES.push({
  ...
  year: 2017,
  importe: '€34 M',
  importeNota: 'Compra fraudulenta de la filial colombiana Inassa del Canal de Isabel II',
  imputados: ['Ignacio González', 'Edmundo Rodríguez Sobrino', 'Ildefonso de Miguel'],
  ultima: '2026-05',
  ...
  noticias: [
    ...
    { fuente: 'Confilegal', titulo: 'La AN fija para septiembre de 2027 el juicio contra González por el campo de golf del Canal',                    fecha: '2025-12-23', url: 'https://confilegal.com/20251223-la-audiencia-nacional-fija-para-septiembre-de-2027-el-juicio-contra-ignacio-gonzalez-por-el-caso-lezo/' },
  ],
});
